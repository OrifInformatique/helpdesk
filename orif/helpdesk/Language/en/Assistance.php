 ...
 */
 ...
 return[
    ...
    <p>
        ...
        The <span class="bg-orange">Standby technician</span> responds to clients while the on call technician <strong>and</strong> the back up technician are absent.
    </p>
    <p>
    ...
    <p>
        Being <span class="present">present</span> means that during the whole period, the technician is in the work area.<br>
        Being <span class="partly-absent">partly absent</span> means that during the majority of the time (not entirely), 
    ...
    <p>
        The availabilites are important to fill : it is impossible in the schedule to add in or generate a schedule for a technician without availabilites.<br>
        During the modification of the schedule, the option "Ignore presences check" allows bypassing those restrictions. 
    ...
    'mentor_details' =>
    '<p>The mentor technician is an experienced technician with the mission of training new technicians at the helpdesk.</p>
