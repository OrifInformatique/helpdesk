...
<div class="action-menu d-flex justify-content-center">
    ...
    {
        case 0:
            echo '<a class="btn" href="'.base_url('/helpdesk/planning/cw_planning').'">'.lang('Helpdesk.btn_back').'</a>';
            break;

        case 1:
            echo '<a class="btn" href="'.base_url('/helpdesk/planning/nw_planning').'">'.lang('Helpdesk.btn_back').'</a>';
            break;
    } ?>
</div>