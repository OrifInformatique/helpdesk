...
<div class="planning">
    ...
    <div class="week">
        <a class="btn btn-last-week" href="<?= base_url('/helpdesk/planning/lw_planning') ?>"><?= lang('Helpdesk.btn_last_week')?></a>

        <?= view('Helpdesk\Common\planning_week', ['planning_type' => $planning_type]) ?>

        <a class="btn btn-next-week" href="<?= base_url('/helpdesk/planning/nw_planning') ?>"><?= lang('Helpdesk.btn_next_week')?></a>
    </div>
            ...
            <tr>
                <th>        
                    <?php if(!empty($planning_data)): ?>
                        <a class="btn btn-edit" href="<?= base_url('/helpdesk/planning/update_planning/0') ?>" title="<?= lang('Helpdesk.btn_edit_planning') ?>"><i class="fa-solid fa-square-pen"></i></a>
                    <?php else: ?>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="21">
                        ...
                        <a class="btn btn-add" href="<?= base_url('/helpdesk/planning/add_technician/0') ?>"><?= lang('Helpdesk.btn_add_technician')?></a>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
