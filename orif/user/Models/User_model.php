...
class User_model extends \CodeIgniter\Model{
    ...
    public function __construct(ConnectionInterface &$db = null, ValidationInterface $validation = null)
    {
        ...
        $this->validationRules=[
            ...
            'user_password'=>['label'=>lang('user_lang.field_password'),
                'rules'=>'required|trim|'
            ...
            'user_password_again'=>['label'=>lang('user_lang.field_password_confirm'),
                ...
                .'min_length['.config("\User\Config\UserConfig")->password_min_length.']|'
                .'max_length['.config("\User\Config\UserConfig")->password_max_length.']|'
                .'matches[user_password]', 'errors' => [
                    'matches'=>lang('Validation.matches', [lang('user_lang.field_password'), lang('user_lang.field_password_confirm')])]],
